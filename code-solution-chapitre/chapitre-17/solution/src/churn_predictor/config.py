...
# --- Ajout du Chapitre 15 ---
# Même principe que MODEL_PATH et DATA_PATH : un chemin ancré sur ROOT_DIR,
# jamais relatif au dossier courant. Dans un container, l'API démarre depuis
# /app, pas depuis la racine du dépôt — un chemin relatif écrirait le journal
# ailleurs à chaque environnement, et check_drift.py ne le trouverait jamais.
PREDICTIONS_LOG = ROOT_DIR / "logs" / "predictions_log.csv"

# --- Ajout du Chapitre 16 ---
# Fichier distinct du journal de drift : deux usages, deux publics, deux
# politiques de rétention. L'auditeur n'a pas à lire des features, et l'équipe
# data n'a pas à lire des traces d'accès.
AUDIT_LOG = ROOT_DIR / "logs" / "audit_log.csv"
